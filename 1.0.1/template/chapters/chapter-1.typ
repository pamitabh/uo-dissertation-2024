...
Opening paragraph introducing the research topic and its significance to the field #cite(<darwin1964origin>). You can cite either using `#cite(<cite-key>)` like #cite(<janeway1989approaching>) or simply as `@<cite-key>` like @janeway1989approaching.
